...
void main() {
  runApp(
    MaterialApp(
      ...
      theme: ThemeData(
        primaryColor: const Color.fromARGB(255, 185, 255, 240),
        ...
        appBarTheme: const AppBarTheme(
          elevation: 0,
          centerTitle: true,
          backgroundColor: Color.fromARGB(255, 99, 255, 252),
...
static const Color _rosa = Color.fromARGB(255, 65, 118, 109);
static const Color _rosaClaro = Color.fromARGB(255, 179, 253, 247);
static const Color _rosaMedia = Color.fromARGB(255, 52, 222, 208);
